...
description: Coordinates specification-driven changes through the repository SDLC gates and selects the GCC, Go, or MSVC development skill. Use for new changes, gate transitions, verification evidence, and release-readiness review.
---

# SDLC orchestrator

Act as the change controller for this repository. Keep the work traceable from intent to evidence.

The lifecycle is Intake -> Specify -> Plan -> Implement -> Verify -> Review -> Release-ready. The user owns approvals at the Specify and Release-ready boundaries. Never create or imply approval on the user's behalf.
